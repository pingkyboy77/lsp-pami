...
@section('content')
    <div class="container py-5">
        <h2 class="modern-title">{{ $title ?? 'Artikel dan Berita' }}</h2>
        <hr class="modern-hr">
            ...
            <div class="col-12">
                <form action="{{ route('informasi.artikel.search') }}" method="GET">
                    <div class="input-group input-group-lg shadow-sm">
                        <input type="text" name="q" class="form-control shadow-none" placeholder="Cari Artikel..."
        ...
        <div class="row g-4">
            ...
            @empty
                <div class="col-12 text-center" data-aos="fade-up">
                    <img src="{{ asset('image/berita-kosong.png') }}" alt="Tidak ada artikel" style="max-width: 300px;"
                        class="mb-3">
                    <p class="text-black">Belum ada artikel atau berita yang tersedia.</p>
                </div>
            @endforelse
        </div>
