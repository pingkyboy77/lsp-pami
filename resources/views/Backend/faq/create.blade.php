        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <h2 class="modern-title">Tambah FAQ Baru</h2>
                    <hr class="modern-hr">
                    <p class="text-muted mb-0">Tambahkan pertanyaan yang sering diajukan beserta jawabannya</p>
                </div>
...
$(document).ready(function() {
    $('#createFaqForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            complete: function() {
                submitBtn.prop('disabled', false).html('<i class="fas fa-save me-1"></i> Simpan FAQ');
            }
        });
    });
});
