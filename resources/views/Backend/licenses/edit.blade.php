    ...
    <div class="container mt-4">
        <div class="card rounded-4 shadow-sm border-0">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    <i class="bi bi-pencil-square"></i> Edit License
                </h4>
            </div>
            <div class="card-body">
                @include('partials.alert')

                <form action="{{ route('admin.licenses.update', $license->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" 
                                       ...
                                       value="{{ old('title', $license->title) }}" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="subtitle" 
                                       ...
                                       value="{{ old('subtitle', $license->subtitle) }}">
                                @error('subtitle')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="desc1" 
                                          ...
                                          rows="3">{{ old('desc1', $license->desc1) }}</textarea>
                                @error('desc1')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="desc2" 
                                          ...
                                          rows="3">{{ old('desc2', $license->desc2) }}</textarea>
                                @error('desc2')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                @if ($license->image)
                                    <div class="mb-2">
                                        ...
                                        <div class="border rounded p-3 text-center bg-light">
                                            <img src="{{ asset($license->image) }}" alt="Current Image" class="img-fluid"
                                ...
                                <input type="file" name="image" 
                                       ...
                                       onchange="previewImage(event, 'license-preview')">
                                @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="order" 
                                       ...
                                       value="{{ old('order', $license->order) }}" min="1" required>
                                @error('order')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="d-flex justify-content-end align-items-center gap-2 mt-4">
                        <button type="submit" class="btn btn-success">
                            <i class="bi bi-check-lg"></i> Update License
                        </button>
