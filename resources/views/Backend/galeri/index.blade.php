...
<div class="container mt-4">
    <div class="card rounded-4 shadow-sm border-0">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">Galeri Kegiatan</h4>
        </div>
        <div class="card-body">
            @include('partials.alert')

            {{-- Update Title Form --}}
            <form action="{{ route('admin.galeri.updateTitle') }}" method="POST">
                @csrf
                <div class="mb-3">
            ...
            {{-- Add Image Form --}}
            <form action="{{ route('admin.galeri.appendImage') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
            ...
            <div class="row mt-4 g-4">
                @forelse ($galeri_images as $index => $img)
                    <div class="col-md-6">
