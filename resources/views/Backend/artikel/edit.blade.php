    ...
    <div class="container mt-4">
        <div class="card rounded-4 shadow-sm border-0">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    <i class="bi bi-pencil-square"></i> Edit Artikel Pelatihan
                </h4>
                ...
                <form action="{{ route('admin.artikel.update', $artikel->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @if ($artikel->image)
                            <div class="mb-3">
                                ...
                                <div class="border rounded p-3 text-center bg-light">
                                    <img src="{{ asset($artikel->image) }}" alt="Current Image" class="img-fluid"
                        ...
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Kosongkan jika tidak ingin mengubah. Max: 2MB. Format: JPG, PNG, SVG, WebP</div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="content" id="editor" class="form-control @error('content') is-invalid @enderror"
                            rows="10">{{ old('content', $artikel->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" name="is_active" class="form-check-input" id="is_active"
                                value="1" {{ old('is_active', $artikel->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-end gap-3">
                        ...
                        <a href="{{ route('admin.artikel.index') }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
